...
class BaseReinforcementLogger(ABC):
    ...
    def _setup_logger(self):
        ...
        # File handler - logs to .log file in result folder
        log_file_path = os.path.join(self._log_config.result_folder, "training.log")
        ...
        logger.info(f"Job ID: {self._log_config.job_id}")
        logger.info(f"Job Name: {self._log_config.job_name}")
